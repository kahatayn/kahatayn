...
<?php endif; ?>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="h-100 bg-secondary p-5">
                        <form action = "/create" action="/action_page.php" method = "post">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="form-floating">
                                    ...
                                    <label name="amount">Enter the amount to be donated</label>
                                </div>
...
</html><?php /**PATH C:\Users\user\kahatayn\resources\views/donate.blade.php ENDPATH**/ ?>